...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FileStreamFileGroup_1DE478AF], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FileStreamFileGroup_1DE478AF.mdf') TO FILEGROUP [FileStreamFileGroup];
