...
:setvar DefaultDataPath "C:\Users\Administrator\AppData\Local\Microsoft\VisualStudio\SSDT\v11.0\carat-sab-dotnet\"
:setvar DefaultLogPath "C:\Users\Administrator\AppData\Local\Microsoft\VisualStudio\SSDT\v11.0\carat-sab-dotnet\"
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FileStreamFileGroup_4F7A3F33], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FileStreamFileGroup_4F7A3F33.mdf') TO FILEGROUP [FileStreamFileGroup];
...
GO
PRINT N'Rename refactoring operation with key 3a5366aa-f422-4bde-b489-5dbe72a84806, 046f5d47-2466-4be0-9886-ec458d1cd6c0, 7a24b641-b410-4c84-b139-6214355671b0, 2e680047-0a4d-46f8-af69-5fc01d83ed5e is skipped, element [dbo].[campaign_type].[Id] (SqlSimpleColumn) will not be renamed to campaign_type_id';


GO
PRINT N'Rename refactoring operation with key 54ecaf6f-5d92-46e8-ae67-ea1d93bc91a3 is skipped, element [dbo].[campaign_type].[campaign_description] (SqlSimpleColumn) will not be renamed to campaign_type_description';
...
GO
ALTER TABLE [dbo].[campaign_document] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[campaign] WITH CHECK CHECK CONSTRAINT [campaign_country_fk];

ALTER TABLE [dbo].[campaign] WITH CHECK CHECK CONSTRAINT [campaign_brand_fk];

ALTER TABLE [dbo].[campaign] WITH CHECK CHECK CONSTRAINT [campaign_campaign_type_fk];

ALTER TABLE [dbo].[campaign] WITH CHECK CHECK CONSTRAINT [campaign_territory_fk];

ALTER TABLE [dbo].[campaign] WITH CHECK CHECK CONSTRAINT [campaign_category_fk];

ALTER TABLE [dbo].[campaign_document] WITH CHECK CHECK CONSTRAINT [campaign_document_campaign_fk];

ALTER TABLE [dbo].[usage] WITH CHECK CHECK CONSTRAINT [usage_usage_type_fk];
