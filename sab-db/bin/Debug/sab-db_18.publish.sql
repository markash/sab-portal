...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FileStreamFileGroup_1E65FC], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FileStreamFileGroup_1E65FC.mdf') TO FILEGROUP [FileStreamFileGroup];
