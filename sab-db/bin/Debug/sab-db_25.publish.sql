...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FileStreamFileGroup_16BA2688], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FileStreamFileGroup_16BA2688.mdf') TO FILEGROUP [FileStreamFileGroup];
...
insert into dbo.brand (brand_id, brand_description) values (14, 'Stone');
insert into dbo.brand (brand_id, brand_description) values (15, 'Hero');
insert into dbo.brand (brand_id, brand_description) values (16, 'Grand');
insert into dbo.brand (brand_id, brand_description) values (17, 'Trophy');
