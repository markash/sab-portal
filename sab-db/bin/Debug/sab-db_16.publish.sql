...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FileStreamFileGroup_53598E6D], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FileStreamFileGroup_53598E6D.mdf') TO FILEGROUP [FileStreamFileGroup];
...
CREATE TABLE [dbo].[campaign_document] (
    ...
    UNIQUE NONCLUSTERED ([serial_number] ASC)
);
